...
namespace ReducedGrinding.Projectiles
{
	public class TestBobber : ModProjectile
	{
		...
		private Color FishingLineColor => new Color(Main.rand.Next(127, 255), Main.rand.Next(127, 255), Main.rand.Next(127, 255));
