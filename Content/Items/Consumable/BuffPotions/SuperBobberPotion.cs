...
{
    public class SuperBobberPotion : ModItem
    {
        ...
        {
            type = GetInstance<BobberPotionConfig>().SuperBobberPotionIngredient.Type;
            type2 = GetInstance<BobberPotionConfig>().SuperBobberPotionAlternateIngredient.Type;
