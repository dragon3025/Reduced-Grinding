...
{
    public class GreaterBobberPotion : ModItem
    {
        ...
        {
            type = GetInstance<BobberPotionConfig>().GreaterBobberPotionIngredient.Type;
            type2 = GetInstance<BobberPotionConfig>().GreaterBobberPotionAlternateIngredient.Type;
