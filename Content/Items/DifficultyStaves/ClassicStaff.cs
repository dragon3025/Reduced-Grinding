...
{
    public class ClassicStaff : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (Main.getGoodWorld)
            {
                ...
                tooltips.Add(new TooltipLine(Mod, "GetGoodWillModifyDifficulty", text.FormatWith("FF9900", Language.GetTextValue("UI.Expert"))));
            }
        ...
        {
            if (Main.gameMenu || Main.GameMode != GameModeID.Normal)
            {
                return true;
            }
        ...
        {
            return DifficultyStavesSystem.RequestDifficulty(player, GameModeID.Normal);
        }
