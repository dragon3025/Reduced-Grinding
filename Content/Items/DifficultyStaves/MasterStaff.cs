    ...
    public class MasterStaff : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (Main.getGoodWorld)
            {
                ...
                tooltips.Add(new TooltipLine(Mod, "GetGoodWillModifyDifficulty", text.FormatWith("32CD32", Language.GetTextValue("UI.Legendary"))));
            }
        ...
        {
            if (Main.gameMenu || Main.GameMode != GameModeID.Master)
            {
                return true;
            }
        ...
        {
            return DifficultyStavesSystem.RequestDifficulty(player, GameModeID.Master);
        }
